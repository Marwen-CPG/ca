...
using AspNet.Identity.AdoNet.Oracle; 
...
namespace Comptabilite_Analytique.Models
{
    ...
    public class ApplicationDbContext : OracleIdentityDbContext
    {
        ...
        public ApplicationDbContext()
            : base(connectionString, nomenclature)
        {
